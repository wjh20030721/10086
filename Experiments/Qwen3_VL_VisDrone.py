...
CONFIG = {
    ...
    "annotation_file": "../Annotation/VisDrone.json",
    "domain_knowledge": "../Knowledge Guide/domain_knowledge_VisDrone.json",
    ...
    with open(CONFIG["results_csv"], 'w', newline='', encoding='utf-8') as csvfile:
        ...
        for idx, (img_path, item_value) in enumerate(filtered_data.items()):
            ...
            for conv in item_value['conversation']:
                ...
                messages = expert_generator_VisDrone(query_img, q_type, question, options_text, domain_knowledge)
